  ...
  return (
    <header className="border-b border-ink/15 bg-paper/95 px-5 py-4 backdrop-blur lg:px-8">
      <div className="mx-auto flex max-w-[1600px] flex-wrap items-center justify-between gap-4">
        <Link className="nav-target flex items-center gap-3 font-semibold" href="/">
        ...
        <nav className="flex items-center gap-2" aria-label="Primary navigation">
          ...
          <Link className="nav-target rounded-full border border-ink/20 px-3 py-1.5 text-xs font-bold uppercase tracking-[0.12em] hover:bg-white" href="/workshop">Open workshop</Link>
        </nav>
      </div>
    </header>
  );
