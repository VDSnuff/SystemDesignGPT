...
Registry-backed child processes preserve existing Node options and prefer IPv4,
avoiding IPv6 connection stalls while retaining the timeout as a fail-closed bound.
